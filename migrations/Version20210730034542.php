 ...
 */
final class Version20210730034542 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contribution (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, trick_id INT DEFAULT NULL, category_id INT NOT NULL, title VARCHAR(255) DEFAULT NULL, lead_in LONGTEXT NOT NULL, content LONGTEXT NOT NULL, date DATETIME NOT NULL, INDEX IDX_EA351E15A76ED395 (user_id), INDEX IDX_EA351E15B281BE2E (trick_id), INDEX IDX_EA351E1512469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE file (id INT AUTO_INCREMENT NOT NULL, trick_id INT NOT NULL, contribution_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, path VARCHAR(255) NOT NULL, type INT NOT NULL, INDEX IDX_8C9F3610B281BE2E (trick_id), INDEX IDX_8C9F3610FE5E5FBD (contribution_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE trick (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, lead_in LONGTEXT NOT NULL, content LONGTEXT NOT NULL, INDEX IDX_D8F0A91E12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE file ADD CONSTRAINT FK_8C9F3610FE5E5FBD FOREIGN KEY (contribution_id) REFERENCES contribution (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE file DROP FOREIGN KEY FK_8C9F3610FE5E5FBD');
